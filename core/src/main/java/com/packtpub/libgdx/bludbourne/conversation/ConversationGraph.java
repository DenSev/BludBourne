...
import com.packtpub.libgdx.bludbourne.observers.ConversationGraphSubject;
...
public class ConversationGraph extends ConversationGraphSubject {
    ...
    public String toString() {
        ...
        for (Entry<String, ArrayList<ConversationChoice>> entry : associatedChoices.entrySet()) {
            outputString.append(String.format("[%s]: ", entry.getKey()));

            for (ConversationChoice choice : entry.getValue()) {
                numberTotalChoices++;
